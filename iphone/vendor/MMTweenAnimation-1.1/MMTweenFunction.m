...
- (void)setupBlocks {
  // MMTweenFunctionLinear
  MMTweenFunctionBlock blockLinear = ^(double t, double b, double c, double d) {
    return c * t / d + b;
  };
  ...
  self.functionTable = @[
    @[ blockLinear, blockLinear, blockLinear ],
    @[ blockBackIn, blockBackOut, blockBackInOut ],
    @[ blockBounceIn, blockBounceOut, blockBounceInOut ],
    @[ blockCircIn, blockCircOut, blockCircInOut ],
    @[ blockCubicIn, blockCubicOut, blockCubicInOut ],
    @[ blockElasticIn, blockElasticOut, blockElasticInOut ],
    @[ blockExpoIn, blockExpoOut, blockExpoInOut ],
    @[ blockQuadIn, blockQuadOut, blockQuadInOut ],
    @[ blockQuartIn, blockQuartOut, blockQuartInOut ],
    @[ blockQuintIn, blockQuintOut, blockQuintInOut ],
    @[ blockSineIn, blockSineOut, blockSineInOut ]
  ];

  self.functionNames =
      @[ @"Linear", @"Back", @"Bounce", @"Circ", @"Cubic", @"Elastic", @"Expo", @"Quad", @"Quart", @"Quint", @"Sine" ];

  self.easingNames = @[ @"EaseIn", @"EaseOut", @"EaseInOut" ];
